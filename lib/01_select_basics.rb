...
def small_and_wealthy
  ...
  from countries
  where countries.area < 2000 and countries.gdp > 5000000000
  SQL
end
...
def scandinavia
  ...
  from countries
  where countries.name in ('Denmark', 'Finland', 'Norway', 'Sweden')
  SQL
end
...
def just_the_right_size
  ...
  from countries
  where countries.area between 200000 and 250000
  SQL
end
